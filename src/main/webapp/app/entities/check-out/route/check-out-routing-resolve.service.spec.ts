...
describe('CheckOut routing resolve service', () => {
  ...
  let resultCheckOut: ICheckOut | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return new ICheckOut if id is not provided', () => {
      // GIVEN
      ...
      expect(resultCheckOut).toEqual(new CheckOut());
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse({ body: null as unknown as CheckOut })));
      mockActivatedRouteSnapshot.params = { id: 123 };
