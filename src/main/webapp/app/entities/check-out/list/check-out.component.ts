...
export class CheckOutComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.checkOutService
      ...
      .subscribe({
        next: (res: HttpResponse<ICheckOut[]>) => {
  ...
  trackId(index: number, item: ICheckOut): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: ICheckOut[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
